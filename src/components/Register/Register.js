import {
          ...
          <Grid container justify="center" >
            <Grid item md={4} text="center" >
              ...
              >
                ...
                <Input required  fullWidth  name="name" value={loggedInUser.name} type="text"color="secondary"
                placeholder="name"
                ></Input>
  ...
  <KeyboardDatePicker
          ...
          />
                ...
                <Input fullWidth name="username" type="text" value={loggedInUser.email}  color="secondary" required
                placeholder="User Name or Email"
                ></Input>
                
                <Input fullWidth  type="text" label="Multiline"  multiline rows={2}
                  name="description"
                  color="secondary"
                  required
